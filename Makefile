...
#    Updated: 2022/12/08 12:19:28 by genouf           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES:= cub3d utils/free \
		...
		utils/window utils/image move render player print_forms utils/intersections utils/intersections_utils utils/utils init_render
